...
export default function AboutPage() {
  ...
  // Add this useEffect right after the useLanguage hook
  useEffect(() => {
    window.scrollTo(0, 0)
  }, [])
  ...
  const values = [
    {
      ...
      description: t("about.value_passion_desc"), // Cambiar de "description" a "desc"
    ...
    },
    {
      ...
      description: t("about.value_experience_desc"), // Cambiar de "description" a "desc"
    ...
    },
    {
      ...
      description: t("about.value_security_desc"), // Cambiar de "description" a "desc"
    ...
    },
    {
      ...
      description: t("about.value_quality_desc"), // Cambiar de "description" a "desc"
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {stats.map((stat, index) => (
              <Card
                key={index}
                className="text-center p-8 bg-white/80 backdrop-blur-xl border-0 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 group"
              >
      ...
      <section className="py-20 bg-gradient-to-br from-blue-50 to-indigo-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-20">
            {/* Mission */}
            <Card className="text-center p-10 bg-white/80 backdrop-blur-xl border-0 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 group">
              <CardContent className="p-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {values.map((value, index) => (
              <Card
                key={index}
                className="p-8 bg-white/80 backdrop-blur-xl border-0 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-105 group"
              >
                <CardContent className="p-0">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {certifications.map((cert, index) => (
              <Card
                key={index}
                className="text-center p-8 bg-white/80 backdrop-blur-xl border-0 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-105 group"
              >
                <CardContent className="p-0">
